...
public class DBUtil {
    ...
    public static ResultSet dbExecuteQuery(String queryStmt)
            throws SQLException, ClassNotFoundException {
        //Declare statement, resultSet and CachedResult as null
        Statement stmt = null;
        ...
        try {
            ...
            dbConnect();
            System.out.println("Select statment: " + queryStmt + "\n");
            ...
            //In order to prevent "java.sql.SQLRecoverableException:
            // Closed Connection: next" error
